							...
							<div class="card product-item border-0 mb-4">
								<div
									...
									<img class="img-fluid w-100"
										src="<c:url value="${product.url }" />"
										alt="Image" style="width: 200px; height: 338px">
								</div>
								<div
								...
								<div
									...
									<a href="<c:url value="/details/${product.id }"/>" class="btn btn-sm text-dark p-0">
									<i class="fas fa-eye text-primary mr-1"></i>View Detail</a> 
										 <%
                    					String myname = (String)session.getAttribute("username");
                    					if(myname!= null){ %>
										<a href="<c:url value="/cart/${product.id }"/>" class="btn btn-sm text-dark p-0">
										<i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>
										<%}else{ %>
											<a href="<c:url value="/login"/>" class="btn btn-sm text-dark p-0">
											<i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>
										<%} %>
								</div>
							</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-12 pb-1">
						<div class="card product-item border-0 mb-4">
							<div
								class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
								<img class="img-fluid w-100"
									src="<c:url value="/resources/img/product-2.jpg" />"
									alt="Image">
							</div>
							<div
								class="card-body border-left border-right text-center p-0 pt-4 pb-3">
							...
							<div
								class="card-footer d-flex justify-content-between bg-light border">
								<a href="details" class="btn btn-sm text-dark p-0"><i
									class="fas fa-eye text-primary mr-1"></i>View Detail</a> <a href="cart "
					...
					<div class="col-lg-4 col-md-6 col-sm-12 pb-1">
						<div class="card product-item border-0 mb-4">
							<div
								class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
								<img class="img-fluid w-100"
									src="<c:url value="/resources/img/product-3.jpg" />"
									alt="Image">
							</div>
							<div
								class="card-body border-left border-right text-center p-0 pt-4 pb-3">
